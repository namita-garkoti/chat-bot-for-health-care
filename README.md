# :two_hearts: Chat-Bot for Health Care using Python 🤖
Final Year Project
...
Chatbots are programs built to automatically engage with received messages. Chatbots can be programmed to respond the same way each time, to respond differentaly to messages containing certain keywords and even to use machine learning to adapt their responses to fit the situation. 
...
- [Namita Garkoti](https://github.com/namita-garkoti)
- [Ritika Joshi]
